...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        prompt += '6. CHECKS SOURCE DIVERSITY — did the initial assessment rely too heavily on one ideological perspective?\n\n';
        
        prompt += '## SOURCE DIVERSITY CHECK\n';
        prompt += 'As part of your amplification, evaluate whether the initial assessment:\n';
        prompt += '- Consulted sources from BOTH left-leaning AND right-leaning perspectives\n';
        prompt += '- Prioritized primary sources over secondary analysis\n';
        prompt += '- Acknowledged the bias positioning of fact-checkers cited\n';
        prompt += '- Sought out the strongest counterarguments (steelman, not strawman)\n';
        prompt += 'If source diversity was lacking, actively search for underrepresented perspectives.\n\n';
        ...
        prompt += '  "sourceDiversityCheck": {\n';
        prompt += '    "leftSourcesUsed": "<yes/no/partial — which ones?>",\n';
        prompt += '    "rightSourcesUsed": "<yes/no/partial — which ones?>",\n';
        prompt += '    "primarySourcesUsed": "<yes/no/partial — which ones?>",\n';
        prompt += '    "gapsIdentified": "<what perspectives were missing?>"\n';
        prompt += '  },\n';
