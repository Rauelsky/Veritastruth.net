...
function buildTrackAPrompt(question, articleText, language) {
    ...
    prompt += '**BOTTOM LINE** - 2-3 sentences synthesizing the assessment into actionable insight. Answer: "So what?" Focus on practical implications, not scores. What should someone DO with this information? Examples: "This warrants skepticism until verified by..." or "The core is sound, but watch for..." or "The evidence supports treating this as reliable for..."\n';
